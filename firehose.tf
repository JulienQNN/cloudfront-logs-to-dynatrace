resource "aws_kinesis_firehose_delivery_stream" "dynatrace_firehose_stream" {
  ...
  kinesis_source_configuration {
    kinesis_stream_arn = aws_kinesis_stream.dynatrace_kinesis_stream.arn
    ...
    processing_configuration {
      ...
      processors {
        ...
        parameters {
          ...
          parameter_value = "${aws_lambda_function.dynatrace_lambda.arn}:$LATEST"
        }
      }
    }
...
data "aws_iam_policy_document" "dynatrace_firehose_document" {
  ...
  statement {
    ...
    resources = ["${aws_lambda_function.dynatrace_lambda.arn}:$LATEST"]
  }
  ...
  statement {
    ...
    condition {
      ...
      values   = [aws_kinesis_stream.dynatrace_kinesis_stream.arn]
    }
  }
}
